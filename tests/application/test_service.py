...
class TestResultRegistrar:
    ...
    def test_register_operation_result(self):
        ...
        result = OperationResult(
            id="step1", kind="operation", operation="test_op", parameters={"param": "value"}, result="output"
        )
    ...
    def test_register_map_result(self):
        ...
        map_items = [
            MapItemResult(id="item1", input="input1", operation="test_op", parameters={}, result="result1"),
            MapItemResult(id="item2", input="input2", operation="test_op", parameters={}, result="result2"),
        ]
        ...
        for call, expected in zip(self.result_store.set.call_args_list, expected_calls, strict=False):
            assert call.args == expected[0]

    def test_register_parallel_result(self):
        """Test registering parallel result."""
        parallel_ops = [
            ParallelOpResult(id="op1", operation="test_op1", parameters={}, result="result1"),
            ParallelOpResult(id="op2", operation="test_op2", parameters={}, result="result2"),
        ]
    ...
    def test_register_mixed_results_sequence(self):
        ...
        operation_result = OperationResult(
            id="step1", kind="operation", operation="op1", parameters={}, result="output1"
        )
        ...
        map_result = MapResult(
            ...
            iterator="item",
            inputs=["a"],
            results=[MapItemResult(id="item1", input="a", operation="op2", parameters={}, result="mapped_a")],
        )
...
class TestLoadWorkflow:
    ...
    def test_load_workflow_from_dict(self):
        ...
        workflow_dict = {
            "steps": [{"id": "step1", "kind": "operation", "operation": "test_op", "parameters": {"param": "value"}}]
        }
    ...
    def test_load_workflow_from_workflow_dsl(self):
        ...
        step = OperationStep(id="step1", operation="test_op", parameters={"param": "value"})
    ...
    def test_load_workflow_validation_called(self):
        ...
        workflow_dict = {
            "steps": [
                {"id": "duplicate", "kind": "operation", "operation": "op1", "parameters": {}},
                {
        ...
        workflow_dict = {
            "steps": [
                ...
                },
                {
                    ...
                    "kind": "parallel",
                    "operations": [
                        {"id": "parallel_op1", "kind": "operation", "operation": "task1", "parameters": {}},
                        {"id": "parallel_op2", "kind": "operation", "operation": "task2", "parameters": {}},
                    ],
                },
            ]
        }
...
class TestExecuteWorkflow:
    ...
    def test_execute_workflow(self):
        ...
        step = OperationStep(id="step1", operation="test_op", parameters={})
        workflow = WorkflowDSL(steps=[step])

        engine = Mock(spec=WorkflowEngine)
        expected_result = WorkflowResult(id="workflow_id", status=WorkflowResultStatus.SUCCESS, results=[])
    ...
    def test_execute_workflow_with_different_engines(self):
        ...
        workflow = WorkflowDSL(steps=[OperationStep(id="step1", operation="op1", parameters={})])
...
class TestWorkflowClient:
    ...
    def test_run_workflow_from_dict(self):
        ...
        workflow_dict = {"steps": [{"id": "step1", "kind": "operation", "operation": "test_op", "parameters": {}}]}
